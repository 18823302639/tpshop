<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:72:"E:\myphp_www\WWW\tpshop\public/../app/admin\view\article\column_add.html";i:1546757786;s:54:"E:\myphp_www\WWW\tpshop\app\admin\view\index\base.html";i:1546749000;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<form class="layui-form" action="<?php echo url('Article/column_add'); ?>" method="post">
    <div class="layui-form-item">
        <label class="layui-form-label">选择栏目</label>
        <div class="layui-input-block">
            <select name="column_pid" lay-verify="required">
                ...
                <option value="<?php echo $vo['column_id']; ?>"><?php echo $vo['column_center']; ?></option>
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <input type="text" name="column_center" required  lay-verify="required" placeholder="请输入标题" autocomplete="off" class="layui-input">
        </div>
    </div>
