<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:76:"E:\myphp_www\WWW\tpshop\public/../app/admin\view\article\category_index.html";i:1546749000;s:54:"E:\myphp_www\WWW\tpshop\app\admin\view\index\base.html";i:1546749000;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<div class="layui-col-md12 ">
    <div class="layui-elem-quote ">
        ...
        <a href="<?php echo url('Article/category_add'); ?>" class="layui-btn layui-btn-warm">添加栏目</a>
    </div>
</div>
<table class="layui-table">
    ...
    <tr>
        ...
        <td>
            <!--<a href="<?php echo url('Article/category_del',['id'=>$vo['category_id']]); ?>" class="layui-btn notice">访问</a>-->
            <a href="<?php echo url('Article/category_del',['id'=>$vo['category_id']]); ?>" class="layui-btn notice">删除</a>
            <a href="<?php echo url('Article/category_upd]',['id'=>$vo['category_id']]); ?>" class="layui-btn ">修改</a> </td>
    </tr>
