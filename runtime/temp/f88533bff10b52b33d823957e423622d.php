<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:65:"E:\myphp_www\WWW\tpshop\public/../app/admin\view\goods\index.html";i:1545223268;s:54:"E:\myphp_www\WWW\tpshop\app\admin\view\index\base.html";i:1545223268;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<div class="layui-layout layui-layout-admin">
    ...
    <div class="layui-elem-quote ">商品类别</div>
</div>
<div class="layui-col-md12 ">
    <div class="layui-elem-quote ">
        <a href="http://www.layui.com" class="layui-btn layui-btn-normal">删除会员</a>
        <a href="<?php echo url('Goods/goods_add'); ?>" class="layui-btn layui-btn-warm">添加类别</a>
    </div>
</div>
    <table class="layui-table">
        ...
        <tr>
            ...
            <td><?php echo str_repeat('——',$vo['laver']); ?><?php echo $vo['goods_center']; ?></td>
            <td>于千万人之中遇见你所遇见的人，于千万年之中，时间的无涯的荒野里…</td>
            <td><a href="<?php echo url('Goods/goods_del',['id'=>$vo['goods_id']]); ?>" class="layui-btn notice">删除</a> <a href="<?php echo url('Goods/goods_upd]',['id'=>$vo['goods_id']]); ?>" class="layui-btn ">修改</a> </td>
        </tr>
