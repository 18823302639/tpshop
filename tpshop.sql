...
CREATE TABLE `tp_article` (
  ...
  `article_time` char(20) DEFAULT NULL COMMENT '写入时间',
...
CREATE TABLE `tp_column` (
  ...
  `column_time` char(20) DEFAULT NULL COMMENT '写入时间',
  `category_id` mediumint(2) DEFAULT NULL COMMENT '类别表id',
  PRIMARY KEY (`column_id`)
) ENGINE=MyISAM AUTO_INCREMENT=30 DEFAULT CHARSET=utf8 ROW_FORMAT=FIXED COMMENT='栏目表';
...
INSERT INTO `tp_column` VALUES ('29', '用户留言', '0', null, '2019-01-10 09:11:21', '1');
...
-- ----------------------------
-- Table structure for `tp_leaving`
-- ----------------------------
DROP TABLE IF EXISTS `tp_leaving`;
CREATE TABLE `tp_leaving` (
  `leaving_id` int(11) NOT NULL AUTO_INCREMENT COMMENT '留言表主键',
  `leaving_name` char(50) DEFAULT NULL COMMENT '联系人姓名',
  `leaving_tel` char(11) DEFAULT NULL COMMENT '联系人电话',
  `leaving_email` char(50) DEFAULT NULL COMMENT '联系人邮箱',
  `leaving_text` varchar(500) DEFAULT NULL COMMENT '留言信息',
  `leaving_file` varchar(200) DEFAULT NULL COMMENT '留言文件路径',
  `leaving_time` char(20) DEFAULT NULL COMMENT '留言时间',
  PRIMARY KEY (`leaving_id`)
) ENGINE=MyISAM AUTO_INCREMENT=3 DEFAULT CHARSET=utf8 COMMENT='留言表';

-- ----------------------------
-- Records of tp_leaving
-- ----------------------------
INSERT INTO `tp_leaving` VALUES ('1', '123', '123', '132', '123', '123', null);
INSERT INTO `tp_leaving` VALUES ('2', '123', '18823302639', '2275415324@qq.com', 'fa', 'uploads/20190110/918f8f48e0f2f30baac14ba7fb467a4d.txt', null);
...
CREATE TABLE `tp_link` (
  ...
  `link_time` char(20) DEFAULT NULL COMMENT '添加时间',
  PRIMARY KEY (`link_id`)
...
-- Records of tp_link
-- ----------------------------
INSERT INTO `tp_link` VALUES ('1', '123', '12356', null);
INSERT INTO `tp_link` VALUES ('2', '111', '111', null);
